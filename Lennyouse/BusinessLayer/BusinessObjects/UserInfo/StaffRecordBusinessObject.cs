...
{
    public class StaffRecordBusinessObject : BaseBusinessObject
    {
        ...
        #region Create
        public OperationResult Create(StaffRecord staffRecord)
        {
            try
            {
        ...
        public async Task<OperationResult> CreateAsync(StaffRecord staffRecord)
        {
            try
            {
                await _dao.CreatAsync(staffRecord);
                return new OperationResult() { Success = true };
            }
            catch (Exception e)
            {
        ...
        #region Update
        public OperationResult Update(StaffRecord staffRecord)
        {
            try
            {
        ...
        public async Task<OperationResult> UpdateAsync(StaffRecord staffRecord)
        {
            try
            {
