...
{
    public class PersonBusinessObject : BaseBusinessObject
    {
        ...
        #region Create
        public OperationResult Create(Person person)
        {
            try
            {
                 _dao.Create(person);
        ...
        public async Task<OperationResult> CreateAsync(Person person)
        {
            try
            {
                await _dao.CreatAsync(person);
                return new OperationResult() { Success = true };
            }
            catch (Exception e)
            {
        ...
        #region Update
        public OperationResult Update(Person person)
        {
            try
            {
                _dao.Update(person);
        ...
        public async Task<OperationResult> UpdateAsync(Person person)
        {
            try
            {
        ...
        #region Delete
        public OperationResult Delete(Person person)
        {
            try
            {
                _dao.Delete(person);
        ...
        public async Task<OperationResult> DeleteAsync(Person person)
        {
            try
            {
