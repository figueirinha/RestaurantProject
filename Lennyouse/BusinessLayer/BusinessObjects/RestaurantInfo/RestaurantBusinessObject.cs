...
{
    public class RestaurantBusinessObject:BaseBusinessObject
    {
        ...
        public async Task<OperationResult> UpdateAsync(Restaurant restaurant)
        {
            try
            {
        ...
        #region Delete
        public OperationResult Delete(Restaurant restaurant)
        {
            try
            {
        ...
        public async Task<OperationResult> DeleteAsync(Restaurant restaurant)
        {
            try
            {
