...
{
    public class StaffTitleBusinessObject:BaseBusinessObject
    {
        ...
        #region Create
        public OperationResult Create(StaffTitle staffTitle)
        {
            try
            {
        ...
        public async Task<OperationResult> CreateAsync(StaffTitle staffTitle)
        {
            try
            {
                await _dao.CreatAsync(staffTitle);
                return new OperationResult() { Success = true };
            }
            catch (Exception e)
            {
        ...
        public OperationResult<StaffTitle> Read(Guid id)
        {
            try
            {
                ...
                using (var transactionScope = new TransactionScope(TransactionScopeOption.Required, transactionOptions, TransactionScopeAsyncFlowOption.Enabled))
                {
                    ...
                    return new OperationResult<StaffTitle>() { Success = true, Result = res };
                }
            }
            catch (Exception e)
            {
        ...
        #region Update
        public OperationResult Update(StaffTitle staffTitle)
        {
            try
            {
        ...
        public async Task<OperationResult> UpdateAsync(StaffTitle staffTitle)
        {
            try
            {
