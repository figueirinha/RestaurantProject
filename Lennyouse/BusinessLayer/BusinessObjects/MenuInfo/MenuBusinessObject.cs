...
{
    public class MenuBusinessObject : BaseBusinessObject
    {
        ...
        #region Update
        public OperationResult Update(Menu Menu)
        {
            try
            {
                _dao.Update(Menu);
        ...
        public async Task<OperationResult> UpdateAsync(Menu Menu)
        {
            try
            {
        ...
        #region Delete
        public OperationResult Delete(Menu Menu)
        {
            try
            {
                _dao.Delete(Menu);
        ...
        public async Task<OperationResult> DeleteAsync(Menu Menu)
        {
            try
            {
